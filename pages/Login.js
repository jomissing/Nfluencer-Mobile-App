...
export default function Login() {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }} className="bg-white dark:bg-[#24293e]">
      <ScrollView
        className="h-full w-full flex-1 bg-white dark:bg-[#24293e]"
          ...
          <View className="flex flex-col items-center gap-5 p-8 w-full h-full justify-center">
            <View className="text-center flex items-center">
              <Image
                ...
                className="w-20 h-20"
              />
              <Text className="text-3xl font-black text-gray-800 dark:text-white dark:mt-3">
                Login
              </Text>
            ...
            <View className="w-full">
              <View
                className={`w-full bg-gray-100 dark:bg-gray-600 p-2 px-4 rounded-xl mb-4 border-2 dark:border-gray-500 ${
                  hasError
                    ? "border-red-700"
              ...
              >
                ...
                <TextInput
                  className=" placeholder:text-gray-400 text-gray-800 text-base font-semibold dark:bg-gray-600 dark:text-white"
              ...
              >
                ...
                />
                <TouchableOpacity
                  className="absolute right-4 top-5 bg-gray-100 dark:bg-gray-600"
              ...
              <View className="flex-col justify-center w-full items-center mt-7">
                ...
                <TouchableOpacity
                  onPress={() =>
                    handleLinkPress(
                      "https://nfluencer-website.vercel.app/signup"
                    )
                  }
                >
